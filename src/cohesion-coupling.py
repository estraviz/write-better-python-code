...
class VehicleRegistry:
    ...
    def __init__(self):
        self._add_vehicle_info("Tesla Model 3", True, 60_000)
        self._add_vehicle_info("Volkswagen ID3", True, 35_000)
        self._add_vehicle_info("BMW 5", False, 45_000)
        self._add_vehicle_info("Tesla Model Y", True, 75_000)
